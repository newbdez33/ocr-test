...
- (IBAction)recognizeIt:(id)sender {
    ...
    Tesseract* tesseract = [[Tesseract alloc] initWithDataPath:@"tessdata" language:@"eng+chi_sim"];
    //[tesseract setVariableValue:@"0123456789" forKey:@"tessedit_char_whitelist"];
    [tesseract setImage:self.photoView.image];
    [tesseract recognize];
    
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"结果" message:[tesseract recognizedText] delegate:nil cancelButtonTitle:@"Yeah!" otherButtonTitles:nil];
    [alert show];
    [tesseract clear];
}
...
- (void)processImage {
    ...
    IplImage* srcImage1 = [self CreateIplImageFromUIImage:self.photoView.image];
...
//    cvSetImageROI(srcImage1, cvRect(x, y, w , h));
    ...
    IplImage* dstImage1 = cvCreateImage(cvSize(width, height), srcImage1->depth, srcImage1->nChannels);
    cvCopy(srcImage1, dstImage1,0);
    //cvResetImageROI(srcImage1);
    self.photoView.image = [self UIImageFromIplImage:dstImage1];
    
    cv::Mat matImage = [self cvMatFromUIImage:self.photoView.image];
    cv::Mat matGrey ;
    ...
    //image = rotate(image, UIImageOrientationUp);
